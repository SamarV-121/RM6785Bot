...
const fetchedCommands = bot.telegram.getMyCommands();

// Compare the fetched and registered commands array
if (
  fetchedCommands !== registeredCommands &&
  fetchedCommands.length !== registeredCommands.length
) {
